...
2. docker exec -u root -it superset pip3 install --target=/app/.venv/lib/python3.10/site-packages snowflake-sqlalchemy
...
## Connect to Snowflake in Superset UI
- Database name: ATMOSYNC
- Username:Nithyashree
- Password:Nithyashreemj@0928
- Account: HCJVOTK-FW80155
- Role: ACCOUNTADMIN

Access Superset at localhost:8088